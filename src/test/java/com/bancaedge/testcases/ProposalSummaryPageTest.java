...
import com.bancaedge.pages.ProposalSummaryPage;
import com.bancaedge.pages.ProposerDetailsPage;

public class ProposalSummaryPageTest extends BaseClass{
...
public void setup(String browser) throws InterruptedException {
	...
	public void checkAllfieldDisplayed() throws InterruptedException {
		...
		proposalsummarypage=new ProposalSummaryPage();
		...
		Thread.sleep(1000);
		proposalsummarypage.clickOnPropSubBtn();
		Thread.sleep(1000);
		proposalsummarypage.enterCustomerConsentOTP(prop.getProperty("MasterOTP"));
		proposalsummarypage.clickOnCustOTPSubBtn();
	}
